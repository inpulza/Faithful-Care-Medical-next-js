...
## Límites
La fase inicial solo comprobó contratos. Posteriormente se verificaron generaciones reales EN/ES e imágenes en Preview; véase AUTO-GENERATE.md.
...
## Auditoría de lanzamiento, 22 septiembre 2026
Los tres jueces revisaron todo main...HEAD. Hallazgos P2 corregidos: pérdida de cambios al salir, cuota incoherente antes de generar, sexta imagen que impedía editar, traducción limitada a tres alts, slug mutable tras publicación y pérdida de fecha original. Se añade aviso de enlaces entrantes antes de retirar artículos y se corrigen idioma/movimiento reducido del preview. No quedan bloqueantes conocidos de las tres auditorías; CI, E2E y SHA desplegado se comprueban nuevamente en el PR20 consolidado.
