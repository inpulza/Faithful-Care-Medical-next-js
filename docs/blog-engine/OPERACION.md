...
## Firma de autora e inicialización autorizada
Jordan pidió el retrato circular y la firma Dr. Addys Reve, MD, verificados en /about y /images/dr-addys-reve.webp. Los artículos nuevos usan esa autora; otros nombres guardados no reciben su foto ni su identidad estructurada. Preview y página pública comparten el perfil. La firma no añade una afirmación de revisión clínica.
Jordan autorizó explícitamente crear una sola vez el esquema de la nueva base de producción mediante seis migraciones aditivas, dentro de Vercel. scripts/vercel-build.mjs solo las ejecuta en production con BLOG_BOOTSTRAP_SCHEMA=faithful-care-initial-schema-20260922. Retirar la bandera después de comprobar el despliegue. Los builds normales no migran. DATABASE_URL permanece Sensitive y nunca se exporta a archivos locales.
