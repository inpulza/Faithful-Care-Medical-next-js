...
try{
 ...
 for(const language of ["en","es"]){
  ...
  const content='<h2>'+(es?'Preparar tu visita':'Preparing your visit')+'</h2>'+Array.from({length:90},()=>'<p>LOCAL QA FIXTURE ONLY. This text validates author layout and does not provide medical guidance.</p>').join('')+'<p><a href="/primary-care">Primary care</a> <a href="/contact">Contact</a> <a href="https://medlineplus.gov/healthscreening.html">MedlinePlus</a></p>';
