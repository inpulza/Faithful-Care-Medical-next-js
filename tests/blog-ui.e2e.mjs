...
try{
 for(const [width,height] of [[1440,900],[390,844]]){
  ...
  await page.getByRole("heading",{name:"Clinical review",exact:true}).waitFor();
  assert(await page.getByRole("button",{name:"Publish reviewed article",exact:true}).isDisabled());
