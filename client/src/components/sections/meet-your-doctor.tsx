...
export function MeetYourDoctor({ ctaHref = "/about" }: MeetYourDoctorProps) {
  return (
    <AlternatingBlock
      ...
      title="Board-certified care with the time to listen."
      ...
      imageAlt="Dr. Addys Reve, MD - Founder of Faithful Care Medical Services, specialist in primary and palliative care in Naples, Florida"
      variant="primary"
    />
  );
}
